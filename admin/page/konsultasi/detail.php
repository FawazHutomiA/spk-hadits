...
<form method ="POST" name="Form">
    <div class="panel panel-default">
        ...
        <div class="table-responsive">
            ...
            <?php
                $i=1;
                $sql2 = "SELECT detail_konsultasi.idrawi,rawi.nmrawi,rawi.thn_lahir,thn_wafat,detail_konsultasi.adil,detail_konsultasi.tsiqah
        ...
        <a href="?page=konsultasi" class="btn btn-danger">Kembali</a>
    </div>
</form>